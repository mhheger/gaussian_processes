...
Maybe we are more interested in visualizing the results in a plot. This
for one-dimensional inputs, this is possible via `plot()`. You can just
...
f <- function(x){log(abs(2*x)+1)+sin(x) }
xx <- runif(25,-10,10) 
yy <- f(xx) + rnorm(25, 0, 0.2)
#Real function
plot(xx,yy)
