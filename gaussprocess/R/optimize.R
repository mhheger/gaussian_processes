...
#' @param x Input values for the covariance function, a numeric vector
#' @param y Input values for the covariance function, a numeric vector
#' 
#' @return The, with "covname", selected covariance function or if specified, the value of the covariance function
#' @example 
